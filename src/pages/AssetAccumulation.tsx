  ...
  const {
    ...
    queryFn: async () => {
      ...
      const {
        data,
        error
      } = await supabase.from('assets').select('*').eq('client_id', clientId).order('created_at', {
        ascending: false
      });
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const {
        data,
        error
      } = await supabase.from('financial_goals').select('*').eq('client_id', clientId).order('created_at', {
        ascending: false
      });
      if (error) throw error;
      return data;
  ...
  return <div className="container mx-auto px-6 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex space-x-1 mb-8 bg-gray-100 p-1 rounded-lg w-fit">
          <button onClick={() => setActiveTab('assets')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'assets' ? 'bg-white text-primary shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}>
            Ativos
          </button>
          <button onClick={() => setActiveTab('goals')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'goals' ? 'bg-white text-primary shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}>
            Metas Financeiras
          </button>
        </div>
        ...
        {activeTab === 'assets' && <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <Button onClick={() => setShowAssetForm(!showAssetForm)} className="bg-primary hover:bg-primary/90">
            ...
            {/* Asset Form */}
            {showAssetForm && <Card className="mb-6">
                <CardHeader>
              ...
              createAssetMutation.mutate(assetFormData);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="type" value={assetFormData.type} onChange={e => setAssetFormData(prev => ({
                    ...prev,
                    type: e.target.value
                  }))} placeholder="Ex: Imóvel, Investimento, Reserva" required />
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="current_value">Valor Atual (R$)</Label>
                        <Input id="current_value" type="number" step="0.01" value={assetFormData.current_value} onChange={e => setAssetFormData(prev => ({
                    ...prev,
                    current_value: e.target.value
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="expected_return" type="number" step="0.01" value={assetFormData.expected_return} onChange={e => setAssetFormData(prev => ({
                    ...prev,
                    expected_return: e.target.value
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={assetFormData.goal_id} onValueChange={value => setAssetFormData(prev => ({
                    ...prev,
                    goal_id: value
                  }))}>
                          <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="description" value={assetFormData.description} onChange={e => setAssetFormData(prev => ({
                  ...prev,
                  description: e.target.value
                }))} placeholder="Descrição do ativo" required />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="observations">Observações</Label>
                      <Textarea id="observations" value={assetFormData.observations} onChange={e => setAssetFormData(prev => ({
                  ...prev,
            ...
            {/* Assets List */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {assets?.map(asset => <Card key={asset.id} className="border-l-4 border-l-green-500">
        ...
        {activeTab === 'goals' && <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <Button onClick={() => setShowGoalForm(!showGoalForm)} className="bg-primary hover:bg-primary/90">
                <Plus className="mr-2 h-4 w-4" />
                Nova Meta
              </Button>
            </div>
            ...
            {/* Goal Form */}
            {showGoalForm && <Card className="mb-6">
                <CardHeader>
              ...
              createGoalMutation.mutate(goalFormData);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="name" value={goalFormData.name} onChange={e => setGoalFormData(prev => ({
                    ...prev,
                    name: e.target.value
                  }))} placeholder="Ex: Casa própria, Reserva de emergência" required />
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="target_value">Valor Desejado (R$)</Label>
                        <Input id="target_value" type="number" step="0.01" value={goalFormData.target_value} onChange={e => setGoalFormData(prev => ({
                    ...prev,
                    target_value: e.target.value
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="current_value">Valor Atual (R$)</Label>
                        <Input id="current_value" type="number" step="0.01" value={goalFormData.current_value} onChange={e => setGoalFormData(prev => ({
                    ...prev,
                    current_value: e.target.value
                  }))} />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="start_month" type="month" value={goalFormData.start_month} onChange={e => setGoalFormData(prev => ({
                    ...prev,
                    start_month: e.target.value
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="end_month" type="month" value={goalFormData.end_month} onChange={e => setGoalFormData(prev => ({
                    ...prev,
                    end_month: e.target.value
                  }))} required />
                      </div>

                      {goalFormData.start_month && goalFormData.end_month && goalFormData.target_value && goalFormData.current_value && <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="observations">Observações</Label>
                      <Textarea id="observations" value={goalFormData.observations} onChange={e => setGoalFormData(prev => ({
                  ...prev,
                  observations: e.target.value
                }))} rows={3} />
                    </div>
            ...
            return <Card key={goal.id} className="border-l-4 border-l-blue-500">
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-600 mt-1">
                            ...
                            {goal.monthly_contribution > 0 && <span>Aporte: {formatCurrency(goal.monthly_contribution)}/mês</span>}
                          </div>
                        </div>
                        <Button variant="outline" size="sm" className="text-red-600">
                          <Trash2 className="h-4 w-4" />
                      ...
                      {goal.deadline && <div className="mt-3 text-sm text-gray-600">
